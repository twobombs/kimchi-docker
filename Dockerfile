...
RUN apt-get install gcc make autoconf automake gettext git pkgconf xsltproc && apt-get clean all
...
RUN apt-get install pep8 pyflakes python3-requests python3-mock bc
