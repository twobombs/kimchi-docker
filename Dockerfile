...
RUN python3 -m pip install --upgrade pip && pip3 install cheetah3 && pip3 install psutil libvirt-daemon-system libvirt0 && pip3 install websockify && pip3 install jsonschema
# pm-utils libvirt-clients libvirt-daemon libvirt-daemon-driver-storage-rbd
